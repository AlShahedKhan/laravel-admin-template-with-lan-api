...
<body>
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Commentry</a>
          <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Full Score</a>
          <a onclick="GraphScore({{ count($curves) != 0 ? $curves[0]->match_id : '' }})" class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Match Graph</a>
        </div>
      </nav>
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            @foreach ($commentries as $commentry)
                <p><strong>{{ $commentry->player->player_name}} </strong>({{ $commentry->player2->player_name}}): {{ $commentry->CommentryCreateDetails->details }}</p>
            @endforeach
        </div>
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
            ...
            <table id="example1" class="table table-bordered table-striped table-sm">
                ...
                <br>
                <p><strong><i>{{ $team }}:-{{ str_replace($EN, $BN, "$totalRun") }}-{{ @$wickets }} ({{ str_replace($EN,$BN, "$totalOvers") }} ওভার)</i></strong></p>
                <style>
                  tr.noBorder td {
                    border: 0;
                  }
