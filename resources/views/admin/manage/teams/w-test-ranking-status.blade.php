...
@section('admin_content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <title>{{ ___('cricket.women_test_teams_ranking') }}</title>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">{{ ___('cricket.women_test_teams_ranking') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered role-table" id="example1">
                            ...
                            <tbody class="tbody">
                                ...
                                @foreach ($data->sortByDesc('w_test_ranking') as $row)
                                    @php
                                        $teamName = $row->team_name;
                                        $ranking = $row->w_test_ranking;
                                    @endphp
                                    <tr>
