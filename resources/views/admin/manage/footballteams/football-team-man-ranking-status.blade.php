        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <title>{{ ___('football.football_teams_man_rankings') }}</title>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">{{ ___('football.football_teams_man_rankings') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ ___('football.football_teams_man_rankings') }}</h4>
