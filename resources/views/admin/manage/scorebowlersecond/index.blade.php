...
@section('admin_content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <title>{{ ___('cricket.bowler_second') }}</title>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ ___('cricket.home') }}</a></li>
                        <li class="breadcrumb-item">{{ ___('cricket.bowler_second') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ ___('cricket.bowler_second') }}</h4>
                    @if (hasPermission('scorebowlersecond_create'))
                        ...
                        <table class="table table-bordered role-table" id="example1">
                            <thead class="thead">
                                <tr>
                                    ...
                                    @if (hasPermission('scorebowlersecond_update') || hasPermission('scorebowlersecond_delete'))
                            ...
                            <tbody class="tbody">
                                @php
                                    ...
                                    $mkData = [];
                                @endphp
                                @foreach ($data['scorebowlersecond'] as $key => $row)
                                    <tr>
                                        @php
                                        ...
                                        @if (hasPermission('scorebowlersecond_update') || hasPermission('scorebowlersecond_delete'))
                                            <td>
                                                @if (hasPermission('scorebowlersecond_update'))
                                                ...
                                                @endif
                                                @if (hasPermission('scorebowlersecond_delete'))
                                                    <a href="{{ route('scorebowlersecond.delete', $row->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ ___('cricket.add_bowler_second_innings') }} </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="close_button">&times;</span>
                    </button>
                </div>
                <form action="{{ route('scorebowlersecond.store') }}" method="Post" class="score_add_form">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="row mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ ___('cricket.update_bowler_second_innings') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="close_button">&times;</span>
                    </button>
                </div>
...
@section('script')
    ...
    <script type="text/javascript">
        function editPost(id) {
            let _url = `scorebowlersecond/edit/${id}`;
        ...
        $('form.score_add_form #match_id').on('change', function(e) {
            ...
            $.ajax({
                ...
                url: '{{ route('getTeamListScorebowlersecond') }}',
                success: function(data) {
        ...
        $('form.score_add_form #team_id').on('change', function(e) {
            ...
            $.ajax({
                ...
                url: '{{ route('getPlayerListScorebowlersecond') }}',
                success: function(data) {
