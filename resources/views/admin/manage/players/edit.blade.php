<form action="{{ route('player.update') }}" method="Post">
    ...
    <div class="modal-body">
        ...
        <div class="from-group">
            ...
            <input type="text" class="form-control" name="player_runs" value="{{ $data->player_runs }}" required="">
        </div>
        <div class="from-group">
            <label for="player_wickets">{{ ___('cricket.player_wickets') }}</label>
            <input type="text" class="form-control" name="player_wickets" value="{{ $data->player_wickets }}" required="">
        </div>
        <div class="from-group">
