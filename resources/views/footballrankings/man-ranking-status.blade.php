...
@section('admin_content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <title>{{ ___('football.man_ranking_status') }}</title>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">{{ ___('football.man_ranking_status') }}</li>
                    </ol>
                </div>
            </div>
        </div>
