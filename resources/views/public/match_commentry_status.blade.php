                ...
                <div class="card-header">
                    ...
                    @if ($table_numbers == 3 || $table_numbers == 4)
                        <h3 style="margin-top: 0.5em">{{ ___('cricket.' . $targatedRuns) }}
                            ...
                            {{ ___('cricket.' . $targetedOvers) }} {{ ___('cricket.balls') }} </h3>
                    @endif
                </div>
                <div class="card-body">
                    ...
                    @if ($table_numbers == 1 || $table_numbers == 2)
                            ...
                            <tbody>
                                <tr>
                                    @foreach ($commentries as $commentry)
                                        <p>
                                            <strong>{{ $commentry->player->player_name }}</strong>
                                            ({{ $commentry->player2->player_name }})
                                            :
                                            {{ $commentry->CommentryCreateDetails->details }}
                                        </p>
                                    @endforeach
                                </tr>
                            </tbody>
